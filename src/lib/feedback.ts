...
const COMBO_MESSAGES: Record<number, FeedbackMessage[]> = {
  ...
  5: [{ text: '5X COMBO!', emoji: '', intensity: 'high', color: 'yellow', image: combo5x }],
  6: [{ text: '6X COMBO!', emoji: '', intensity: 'high', color: 'purple', image: combo6x }],
  7: [{ text: '7X COMBO!', emoji: '', intensity: 'high', color: 'purple', image: combo7x }],
  8: [{ text: '8X COMBO!', emoji: '', intensity: 'high', color: 'cyan', image: combo8x }],
  9: [{ text: '9X COMBO!', emoji: '', intensity: 'high', color: 'cyan', image: combo9x }],
  10: [{ text: '10X COMBO!', emoji: '', intensity: 'high', color: 'cyan', image: combo10x }],
  // 11+: Use 10x image as fallback
  11: [{ text: '11X COMBO!', emoji: '⚡', intensity: 'high', color: 'yellow', image: combo10x }],
  12: [{ text: '12X COMBO!', emoji: '⚡', intensity: 'high', color: 'yellow', image: combo10x }],
  13: [{ text: '13X COMBO!', emoji: '⚡', intensity: 'high', color: 'yellow', image: combo10x }],
  14: [{ text: '14X COMBO!', emoji: '⚡', intensity: 'high', color: 'yellow', image: combo10x }],
  15: [{ text: '15X COMBO!', emoji: '⚡', intensity: 'high', color: 'yellow', image: combo10x }],
  16: [{ text: '16X COMBO!', emoji: '💥', intensity: 'high', color: 'pink', image: combo10x }],
  17: [{ text: '17X COMBO!', emoji: '💥', intensity: 'high', color: 'pink', image: combo10x }],
  18: [{ text: '18X COMBO!', emoji: '💥', intensity: 'high', color: 'pink', image: combo10x }],
  19: [{ text: '19X COMBO!', emoji: '💥', intensity: 'high', color: 'pink', image: combo10x }],
  20: [{ text: '20X COMBO!', emoji: '💥', intensity: 'high', color: 'pink', image: combo10x }],
